define(['jquery', 'underscore', 'backbone' , 'cookies', 'util', 'when'], function ($, _, Backbone, Cookies, Util, when) {
    ...
    function Renderer() {
        ...
        this.apiURL = 'https://agentmate.herokuapp.com/';
        this.assetsURL = 'https://res.cloudinary.com/mateassets/image/upload/v1534874788/';
...
//            console.log('DESTROY:',this.options.src);
        ...
        this.ajaxRequest = function (options) {
            ...
            if(options.url && this.apiURL && options.local !== true) {
